...
class ItemController extends Controller
{
    ...
    {
        //
        return Item::select('oldPrice','ItemName','newPrice','Description','ItemImg','size','Qty','crust','id')->paginate(6);
...
public function selectMenuType($menuID){
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $item->newPrice = $request->input('newPrice');
            $item->Description = $request->input('Description');
            $item->ItemImg = $request->input('ItemImg');
            $item->oldPrice = $request->input('oldPrice');
            $item->save();
